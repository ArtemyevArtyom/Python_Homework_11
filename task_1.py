...
for el in words:
    print(f'{el} - буквенный формат - тип переменной {type(el)}')
# Преобразуем с помощью онлайн-конвертера:
Unicode_format = [
    '\u0440\u0430\u0437\u0440\u0430\u0431\u043e\u0442\u043a\u0430',
    '\u0441\u043e\u043a\u0435\u0442',
    '\u0434\u0435\u043a\u043e\u0440\u0430\u0442\u043e\u0440']
print()
for el in Unicode_format:
    print(f'{el} - набор кодовых точек имеет тип {type(el)}')
